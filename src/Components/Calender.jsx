...
function CustomCalendar() {
  ...
  return (
    <Card shadow="md" radius="md" p="lg" style={{ margin: "auto" , backgroundColor : 'lightgreen'}}>
      {/* Header */}
  ...
  styles={{
    day: {
      ...
      "&[data-selected]": { backgroundColor: "#007bff", color: "white" }, /* Highlight only selected date */
      "&:hover": { backgroundColor: "#f1f3f5" } /* Hover effect */
    },
